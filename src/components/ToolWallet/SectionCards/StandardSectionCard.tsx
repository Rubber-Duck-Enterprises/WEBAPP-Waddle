...
/**
 * Card unificada para secciones Standard y Savings.
 * La diferencia es solo la etiqueta del progreso.
 */
const StandardSectionCard: React.FC<Props> = ({
  ...
  const progressLabel = section.type === "savings" ? "Objetivo" : "Progreso";
      ...
      {goal && goal > 0 && (
        <>
          <div className={styles.goalRow}>
            <span className={styles.goalLabel}>{progressLabel}</span>
